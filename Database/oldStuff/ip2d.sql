...
INSERT INTO `category` (`categoryId`, `categoryName`, `quizId`, `questionId`) VALUES
(1, 'Math', NULL, NULL),
(2, 'Geography', NULL, NULL),
(3, 'Computer Science', NULL, NULL);
...
INSERT INTO `questions` (`questionId`, `questionDesc`, `categoryId`, `answerId`) VALUES
(1, '491/9=?', 1, NULL),
(2, '703/6', 1, NULL),
(3, 'Express 71/1000 as a decimal.', 1, NULL),
(4, ' 4.7 + .9 + .01 =', 1, NULL),
(5, '33 × .59 =?', 1, NULL),
(6, '.84/0.7 =?', 1, NULL),
(7, 'Express the ten thousandths place in 1.7389', 1, NULL),
(8, '1.87 – 1.48 =?', 1, NULL),
(9, 'Round 3.864 to the nearest tenth.', 1, NULL),
(10, 'Which is the equivalent decimal number for forty n', 1, NULL),
(11, 'What is the only country with a coastline on both ', 2, NULL),
(12, 'Which river flows through Paris?', 2, NULL),
(13, 'Where in the British isles is Lady Isabella, the w', 2, NULL),
(14, 'What is the capital city of Slovenia, formerly par', 2, NULL),
(15, 'Which European country shares its border with the ', 2, NULL),
(16, 'Which Asian country is bigger than France, Spain a', 2, NULL),
(17, 'What is Europe’s largest port?', 2, NULL),
(18, 'Hamilton is the capital of which island in the Nor', 2, NULL),
(19, 'In which country is the UK’s highest mountain, Ben', 2, NULL),
(20, 'Mount Vesuvius overlooks which modern Italian city', 2, NULL),
(21, 'What is CPU an acronym for?', 3, NULL),
(22, 'What is RAM?', 3, NULL),
(23, 'What are the home row keys on a keyboard?', 3, NULL),
(24, 'SCRATCH is a program used to do what in computer s', 3, NULL),
(25, 'Which of the following is a form of cyberbullying?', 3, NULL),
(26, 'This is used to connect your computer to the Inter', 3, NULL),
(27, 'When using Microsoft Publisher, you would create w', 3, NULL),
(28, 'Microsoft Word is used to create which of the foll', 3, NULL),
(29, 'When saving files on your computer, which characte', 3, NULL),
(30, 'In Microsoft Office programs, this enables the use', 3, NULL);
...
(1, 'Federico', 'Vivaldo', 'fviv@cal.com', 'pass1', 0),
...
ALTER TABLE `questions`
  ...
  ADD CONSTRAINT `questions_ibfk_2` FOREIGN KEY (`answerId`) REFERENCES `answers` (`answerId`);
